...
**Sort engine:** C `qsort` (libc — typically introsort or mergesort)
...
C heap (malloc'd int64_t array)
  │
  │  qsort() — libc sort, typically O(n log n) introsort
  │
  ▼
Sorted C array
  │
